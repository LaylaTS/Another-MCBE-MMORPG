...
title @a[scores={joined=0}] subtitle §lCurrent version:§r §o§7pre-0.1.0
give @a[hasitem=[{item=mmorpg:orepickaxe, quantity=0}]] mmorpg:orepickaxe 1 0 {"minecraft:can_destroy":{"blocks":["iron_ore", "diamond_ore", "coal_ore", "emerald_ore"]},"minecraft:item_lock":{ "mode": "lock_in_inventory" }}
